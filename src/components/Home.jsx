    ...
    return (
        <div name='home' className='w-full h-screen bg-[#0a192f]'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <h2 className='text-3xl sm:text-6xl font-bold text-[#8892b0]'>I build products for the &lt;<span className='text-red-500'>web</span>/&gt;.</h2>
                <p className ='text-[#8892b0] py-4 max-w-[700px]'>
                    I am a Full-Stack developer specializing in building robust applications, who is curious by nature and empathy minded.
